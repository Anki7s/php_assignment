        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <img src="assets\images\index.jpg" class="img-rounded" alt="Cinque Terre"> 
              <h2 class="mb-30">Add User</h2>
            </div>
          </div>
          <div class="col-lg-6"  class="contactForm">
          <?php echo form_open_multipart('dashboard/addUser'); ?>
              <div class="row">
              <div class="col-lg-6">
                ...
                <div class="col-md-6">
                  <?php foreach($productList as $product){?>
                    <div class="checkbox">
                    <label><input type="checkbox" name= "product[]" value="<?php echo $product['ProductId']?>"><?php echo $product["ProductName"]?></label>
                  </div>
                  <?php } ?>
                </div>
                <div class="col-lg-12">
